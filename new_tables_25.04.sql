...
-- Проверка существования таблицы steps и удаление, если она существует
DO $$ 
BEGIN 
...
-- Проверка существования таблицы pulses и удаление, если она существует
DO $$ 
BEGIN 
...
-- Создание таблицы pulses
CREATE TABLE pulses (
    id SERIAL PRIMARY KEY,
	step_id INTEGER REFERENCES steps(id),
    pulses JSON,
	reper_amplitude FLOAT,
	analyt_amplitude FLOAT,
